...
if (!DevExpress.MOD_WIDGETS) {
    ...
    (function($, DX, undefined) {
        ...
        ui.NativeScrollableStrategy = DX.Class.inherit({
            ...
            _eachScrollbar: function(callback) {
                ...
                $.each(this._scrollbars || {}, function(_, scrollbar) {
                    callback(scrollbar)
                })
            },
            ...
            _createActionArgs: function() {
                ...
                return {
                        ...
                        reachedRight: this._isDirection(HORIZONTAL) ? location.left <= this._containerSize.width - this._contentSize.width : undefined,
                        reachedTop: this._isDirection(VERTICAL) ? location.top >= 0 : undefined,
                        reachedBottom: this._isDirection(VERTICAL) ? location.top <= this._containerSize.height - this._contentSize.height : undefined
                    }
            },
            ...
            _updateScrollbars: function() {
                this._eachScrollbar(function(scrollbar) {
                    var dimension = this._isDirection(VERTICAL) ? "height" : "width";
                    scrollbar.option({
                        containerSize: this._containerSize[dimension],
                        contentSize: this._contentSize[dimension]
                    })
                })
            },
            _updateScrollingAbility: function() {
                var allowedVertical = this._$content.height() > this._containerSize.height;
                var allowedHorizontal = this._$content.width() > this._containerSize.width;
    ...
    (function($, DX, undefined) {
        ...
        var Scroller = ui.Scroller = DX.Class.inherit({
                ...
                _handleMoveEnd: function(velocity) {
                    ...
                    this._handleInertia();
                    this._resertThumbScrolling();
                    return this._completeDeferred.promise()
                },
                _resertThumbScrolling: function() {
        ...
        ui.SimulatedScrollableStrategy = DX.Class.inherit({
            ...
            _handleKeyDown: function(e) {
                if (document.activeElement !== this._$container.get(0))
                    return;
                var handled = true;
                switch (e.keyCode) {
                    case KEY_CODES.DOWN:
    ...
    (function($, DX, undefined) {
        ...
        ui.registerComponent("dxSwitch", ui.Widget.inherit({
            ...
            _updateMarginBound: function() {
                this._marginBound = this._$switchWrapper.outerWidth(true) - this._$handle.outerWidth()
            },
    ...
    (function($, DX, undefined) {
        ...
        ui.registerComponent("dxEditBox", ui.Widget.inherit({
            ...
            _renderValueUpdateEvent: function() {
                ...
                var valueUpdateEventName = events.addNamespace(this.option("valueUpdateEvent"), eventNamespace);
                this._input().off("." + eventNamespace).on(valueUpdateEventName, $.proxy(this._handleValueChange, this));
        ...
        ui.registerComponent("dxTextBox", ui.dxEditBox.inherit({
            ...
            _renderSearchMode: function() {
                ...
                if (switchingOn) {
                    ...
                    this._renderFocusEvent($element);
                    this._renderEmptyEvent($element);
            ...
            _renderClearButton: function() {
                var $clearButton = $("<span>").addClass(CLEAR_BUTTON_CLASS).append($("<span>").addClass(CLEAR_ICON_CLASS)).click($.proxy(function() {
                        this.option("value", "")
                    }, this));
                this._$element.append($clearButton);
            ...
            _renderEmptyEvent: function($element) {
                this._input().bind("input", $.proxy(this._toggleEmptyClass, this));
            ...
            _toggleEmptyClass: function() {
                this._$element.toggleClass(EMPTY_INPUT_CLASS, this._input().val() === "")
            },
            _isAndroid: function() {
    ...
    (function($, DX, undefined) {
        ...
        ui.registerComponent("dxSlider", ui.Widget.inherit({
            ...
            _renderDimensions: function() {
                this.callBase();
                if (this._$bar) {
                    this._$bar.width(this.option("width"));
                    this._renderValue()
                }
            },
    ...
    (function($, DX, undefined) {
        ...
        var SwitchableDeleteDecorator = ListEditDecorator.inherit({
                ...
                _animateToggleDelete: function($itemElement, readyToDelete) {
                    if (readyToDelete) {
                        ...
                        this._animateForgetDeleteReady($itemElement).done($.proxy(this._forgetDeleteReady, this, $itemElement))
                },
        ...
        var SwitchableButtonDeleteDecorator = SwitchableDeleteDecorator.inherit({
                _init: function() {
                    ...
                    this._$button = $buttonContainer
                },
                _prepareDeleteReady: function($itemElement) {
                    this.callBase.apply(this, arguments);
                    fx.stop(this._$button, true);
                    this._$button.appendTo($itemElement)
                },
                _animatePrepareDeleteReady: function() {
                    return fx.animate(this._$button, {
                            type: "custom",
                            duration: SWITCHABLE_DELETE_BUTTON_ANIMATION_DURATION,
                            from: {right: -this._buttonWidth()},
                            to: {right: 0}
                        })
                },
                _animateForgetDeleteReady: function() {
                    return fx.animate(this._$button, {
                            ...
                            duration: SWITCHABLE_DELETE_BUTTON_ANIMATION_DURATION,
                            from: {right: 0},
                            to: {right: -this._buttonWidth()}
                        })
                },
                _forgetDeleteReady: function() {
                    this.callBase.apply(this, arguments);
                    this._$button.detach()
                },
                _buttonWidth: function() {
                    if (!this._buttonContainerWidth)
                        this._buttonContainerWidth = this._$button.outerWidth();
        ...
        var SLIDE_ITEM_WRAPPER_CLASS = "dx-slide-item-wrapper",
            ...
            SLIDE_ITEM_POSITIONING_CLASS = "dx-slide-item-positioning";
        registerDecorator("delete", "slideItem", SwitchableDeleteDecorator.inherit({
            ...
            _init: function() {
                ...
                this._$buttonContainer = $("<div/>").addClass(SLIDE_ITEM_DELETE_BUTTON_CONTAINER_CLASS).append($button);
            ...
            modifyElement: function(config) {
                this.callBase.apply(this, arguments);
                var $itemElement = config.$itemElement;
                $itemElement.wrapInner($("<div/>").addClass(SLIDE_ITEM_CONTENT_CLASS)).addClass(SLIDE_ITEM_WRAPPER_CLASS)
            },
            _handleSwipeUpdate: function($itemElement, args) {
                this._togglePositioning($itemElement, true);
                ...
                this._$buttonContainer.css("left", Math.max(this._cachedItemWidth + position, this._minButtonContainerLeftOffset()));
                return true
            },
            _togglePositioning: function($itemElement, readyToPositioning) {
                $itemElement.toggleClass(SLIDE_ITEM_POSITIONING_CLASS, readyToPositioning);
            ...
            _animatePrepareDeleteReady: function() {
                ...
                var buttonAnimation = fx.animate(this._$buttonContainer, {
            ...
            _animateForgetDeleteReady: function($itemElement) {
                ...
                var buttonAnimation = fx.animate(this._$buttonContainer, {
                        ...
                        complete: $.proxy(function() {
                            this._$buttonContainer.css("left", "100%")
                        }, this)
                    });
                return $.when(contentAnimation, buttonAnimation).promise()
            },
            _forgetDeleteReady: function($itemElement) {
                this.callBase.apply(this, arguments);
                this._togglePositioning($itemElement, false);
        ...
        ui.registerComponent("dxList", ui.CollectionContainerWidget.inherit({
            ...
            deleteItem: function(itemElement) {
                ...
                deferred.done(function() {
                    ...
                    self._handleItemEvent($item, "itemDeleteAction", {}, {excludeValidators: ["gesture", "disabled"]});
    ...
    (function($, DX, undefined) {
        ...
        var fromStandardDateFormat = function(date) {
                return Globalize.parseDate(date, FORMATS_INFO["datetime"].standardPattern) || Globalize.parseDate(date, FORMATS_INFO["datetime-local"].standardPattern) || Globalize.parseDate(date, FORMATS_INFO["time"].standardPattern) || Globalize.parseDate(date, FORMATS_INFO["date"].standardPattern)
            };
    ...
    (function($, DX, undefined) {
        ...
        ui.registerComponent("dxAutocomplete", ui.ContainerWidget.inherit({
            ...
            _renderDimensions: function() {
                this.callBase();
                if (this._textbox) {
                    this._textbox.option("width", this.option("width"));
                    this._textbox.option("height", this.option("height"))
                }
                if (this._popup)
            ...
            _renderPopup: function() {
                ...
                this._renderList();
                this._autocompleteResizeCallback = $.proxy(this._calculatePopupDimensions, this);
    ...
    (function($, DX, undefined) {
        var ui = DX.ui,
            ...
            POPUP_CLASS = WIDGET_CLASS + "-popup",
            SELECTBOX_CONTAINER_CLASS = WIDGET_CLASS + "-container",
            SELECTBOX_ARROW_CLASS = WIDGET_CLASS + "-arrow",
            SELECTBOX_ARROW_CONTAINER_CLASS = SELECTBOX_ARROW_CLASS + "-container";
        ui.registerComponent("dxSelectBox", ui.dxAutocomplete.inherit({
            ...
            _renderContainer: function() {
                this._textbox._element().wrap($("<div>").addClass(SELECTBOX_CONTAINER_CLASS));
                this._$container = this._element().find("." + SELECTBOX_CONTAINER_CLASS)
            },
            _renderPopup: function() {
                this.callBase();
            ...
            _renderArrowDown: function() {
                ...
                $("<div>").addClass(SELECTBOX_ARROW_CONTAINER_CLASS).appendTo(this._$container).on(events.addNamespace("dxclick", this.NAME), $.proxy(function() {
                    clickActionHandler()
                }, this));
                $("<div>").addClass(SELECTBOX_ARROW_CLASS).appendTo(this._$container.find("." + SELECTBOX_ARROW_CONTAINER_CLASS))
            },
            _applyFilter: $.noop,
            _updateValue: $.noop,
            _renderTextbox: function() {
